...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job_type', models.CharField(choices=[('ST', 'Selective transfer job'), ('BT', 'Batch transfer job')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modalities', models.CharField(blank=True, max_length=100, null=True)),
