...
class BatchTransferJobCreateTest(TestCase):
    ...
    @patch("batch_transfer.views.batch_transfer_task")
    def test_batch_job_created_and_enqueued(
        self, batch_transfer_task_mock, must_be_scheduled_mock
    ):
        self.client.force_login(self.user_with_permission)
        ...
        batch_transfer_task_mock.delay.assert_called_once_with(job.id)
