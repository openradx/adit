...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': (('can_cancel_batchtransferjob', 'Can cancel batch transfer job'), ('can_transfer_unpseudonymized', 'Can transfer unpseudonymized')),
            },
            bases=('main.dicomjob',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('UP', 'Unprocessed'), ('SU', 'Success'), ('WA', 'Warning'), ('ER', 'Error')], default='UP', max_length=2)),
