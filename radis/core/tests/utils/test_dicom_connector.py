...
from radis.core.utils.dicom_connector import DicomConnector
from radis.core.utils.file_transmit import FileTransmitServer

from .conftest import DicomTestHelper


@patch("radis.core.utils.dicom_connector.AE.associate")
...
def test_download_series_with_c_get(
    ...
    # Arrange
    mocker.patch("radis.core.utils.dicom_connector.AE.associate", return_value=association)
