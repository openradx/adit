    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='qido_rs.dicomqidojob')),
            ],
            options={
                'ordering': ('task_id',),
                'abstract': False,
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['owner', 'status'], name='qido_rs_dic_owner_i_9573bb_idx'),
        ),
    ]
