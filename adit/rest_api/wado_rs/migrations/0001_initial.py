    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("boundary", models.CharField(blank=True, max_length=64)),
                ("folder_path", models.CharField(blank=True, max_length=128)),
                ("file_path", models.CharField(blank=True, max_length=128)),
                (
                    "owner",
                    models.ForeignKey(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["owner", "status"], name="wado_rs_dic_owner_i_e109b4_idx"),
        ),
    ]
