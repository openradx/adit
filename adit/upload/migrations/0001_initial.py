# Generated by Django 5.0.4 on 2024-06-03 14:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series_uids', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=64, validators=[django.core.validators.RegexValidator(message='Invalid character in UID.', regex='^[\\d\\.]+$')]), blank=True, default=list, size=None)),
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='upload.uploadjob')),
