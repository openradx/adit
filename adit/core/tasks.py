...
class ProcessDicomJob(CeleryTask):
    ...
    def run(self, dicom_job_id: str):  # pylint: disable=arguments-differ
...
class ProcessDicomTask(AbortableCeleryTask):
    ...
    def run(self, dicom_task_id: int):  # pylint: disable=arguments-differ
...
class HandleFinishedDicomJob(CeleryTask):
    ...
    def run(
        self, dicom_task_status_list: List[str], dicom_job_id: int
