...
class TestRetrieveAPIView:
    ...
    @patch("adit.dicom_web.views.RetrieveAPIView._get_pseudonym")
    ...
    async def test_retrieve_study_with_invalid_pseudonym(
        ...
        mock_get_pseudonym.side_effect = ValidationError("Invalid pseudonym")
        ...
        mock_get_pseudonym.assert_called_once_with(mock_request)
