...
def test_retrieve_nifti_study(channels_live_server: ChannelsLiveServer):
    ...
    with tempfile.TemporaryDirectory() as temp_output_folder:
        ...
        converted_files = list(temp_output_path.glob("*.nii.gz"))
        assert len(converted_files) > 0, "No NIfTI files were generated by DicomToNiftiConverter"

        # Compare filenames and contents
