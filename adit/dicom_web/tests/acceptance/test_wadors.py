...
def test_retrieve_nifti_study(channels_live_server: ChannelsLiveServer):
    ...
    with tempfile.TemporaryDirectory() as temp_output_folder:
        ...
        assert len(converted_nii_files) > 0, (
            "No NIfTI files were generated by DicomToNiftiConverter"
        )
        assert len(converted_json_files) > 0, (
            "No JSON files were generated by DicomToNiftiConverter"
        )
