# Generated by Django 3.1.2 on 2020-10-14 10:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_slot_begin_time', models.TimeField(default=datetime.time(22, 0), help_text='Must be set in UTC time.')),
                ('batch_slot_end_time', models.TimeField(default=datetime.time(8, 0), help_text='Must be set in UTC time.')),
