...
def job_control_panel(context: dict[str, Any]) -> dict[str, Any]:
    return {
        "job_delete_url": "selective_transfer_job_delete",
        "job_verify_url": "selective_transfer_job_verify",
        "job_cancel_url": "selective_transfer_job_cancel",
        "job_resume_url": "selective_transfer_job_resume",
        "job_retry_url": "selective_transfer_job_retry",
        "job_restart_url": "selective_transfer_job_restart",
        "user": context["user"],
        "job": context["job"],
    }
