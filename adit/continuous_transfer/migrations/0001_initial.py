    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.DateTimeField(blank=True, null=True)),
            ...
            options={
                'permissions': [('can_process_urgently', 'Can process urgently (prioritized and without scheduling).'), ('can_transfer_unpseudonymized', 'Can transfer data without pseudonymization.')],
                'abstract': False,
            },
        ),
        migrations.CreateModel(
