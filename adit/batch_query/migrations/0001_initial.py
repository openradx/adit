# Generated by Django 3.1.3 on 2020-12-29 23:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='queries', to='batch_query.batchqueryjob')),
            ],
            options={
                'ordering': ('batch_id',),
                'abstract': False,
