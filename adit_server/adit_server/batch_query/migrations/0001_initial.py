    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='batch_query_jobs', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modalities', models.JSONField(blank=True, null=True, validators=[adit_server.core.validators.validate_modalities])),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='batch_query.batchqueryjob')),
            ],
            options={
                'ordering': ('batch_id',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='results', to='batch_query.batchqueryjob')),
                ('query', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='results', to='batch_query.batchquerytask')),
            ],
        ),
        migrations.AddIndex(
            model_name='batchqueryjob',
            index=models.Index(fields=['owner', 'status'], name='batch_query_owner_i_265d08_idx'),
        ),
    ]
