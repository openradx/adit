...
from adit_server.batch_transfer.forms import BatchTransferJobForm
from adit_server.batch_transfer.utils.testing_helpers import (
...
def test_with_valid_data(mocker: MockerFixture):
    ...
    parse_mock = mocker.patch(
        "adit_server.batch_transfer.forms.BatchTransferFileParser.parse", autospec=True
    )
