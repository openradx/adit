...
SOURCE_PATHS = [BASE_PATH / "adit_server"]
...
INSTALLED_APPS = [
    ...
    "rest_framework",
    "adrf",
    "adit_server.core.apps.CoreConfig",
    "adit_radis_shared.accounts.apps.AccountsConfig",
    "adit_radis_shared.token_authentication.apps.TokenAuthenticationConfig",
    "adit_server.selective_transfer.apps.SelectiveTransferConfig",
    "adit_server.batch_query.apps.BatchQueryConfig",
    "adit_server.batch_transfer.apps.BatchTransferConfig",
    "adit_server.dicom_explorer.apps.DicomExplorerConfig",
    "adit_server.dicom_web.apps.DicomWebConfig",
    "channels",
]
...
WSGI_APPLICATION = "adit_server.wsgi.application"

ASGI_APPLICATION = "adit_server.asgi.application"
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "adit_server.dicom_web.exceptions.dicom_web_exception_handler",
}
...
STATICFILES_DIRS = (BASE_PATH / "adit_server" / "static",)
