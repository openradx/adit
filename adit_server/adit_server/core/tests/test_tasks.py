...
from adit_server.core.errors import RetriableDicomError
from adit_server.core.models import DicomJob, DicomTask
from adit_server.core.processors import DicomTaskProcessor
from adit_server.core.types import ProcessingResult
...
def patch_dicom_processors(mocker: MockerFixture):
    ...
    mocker.patch.dict(
        "adit_server.core.utils.task_utils.dicom_processors", {f"{model_label}": ExampleProcessor}
    )
