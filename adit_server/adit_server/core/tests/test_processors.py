...
from adit_server.core.models import TransferJob, TransferTask
from adit_server.core.processors import TransferTaskProcessor
from adit_server.core.utils.auth_utils import grant_access
from adit_server.core.utils.dicom_operator import DicomOperator
from adit_server.core.utils.testing_helpers import create_example_transfer_group, create_resources
...
def test_transfer_to_folder_succeeds(mocker: MockerFixture):
    ...
    mocker.patch("adit_server.core.processors.os.mkdir", autospec=True)
